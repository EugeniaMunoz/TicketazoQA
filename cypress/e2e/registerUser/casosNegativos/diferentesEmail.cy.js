...
describe('Registro de Usuario - Emails no coinciden', () => {
    ...
    it('Error al ingresar dos emails diferentes', 
        () => {
        ...
        cy.get('[data-cy="input-confirmar-email"]').click().type('munozeuge15@gmail.com')
        ...
        error.errorMessage.should('contain', 'Los correos electrónicos no coinciden'); 
    });
});